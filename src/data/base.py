...
class TransformerDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        batch_size: int = 32, # only for use train_dataloader
        num_workers: int = 0, 
        dataset_name: Optional[str] = None, # 'path' in load_dataset
        dataset_config_name: Optional[str] = None, # 'name' in load_dataset
        ...
        padding: Union[str, bool] = "max_length", # padding -> 'max_length', not padding -> False (dynamic padding)
        truncation: str = "longest_first", # True == 'longest_first'
        max_length: int = 128,
